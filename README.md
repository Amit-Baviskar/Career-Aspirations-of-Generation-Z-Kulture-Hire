# Career-Aspirations-of-Generation-Z-Kulture-Hire
...
##   4. Key Findings
   ...
   - 1. **Influencing Factors**
         ...
         - 33.9% of respondents are primarily influenced by parents

         - Other key influences include world leaders, social media, influencers, and peers

   - 2. **Company Values & Alignment**

        - 76.1% are unwilling to work for companies misaligned with their values

        - 72.2% avoid organizations lacking a clear mission or purpose

   - 3. **Work-Life Balance**

        - Gen Z prioritizes work-life balance over salary

        - 82.3% refuse to work in unhealthy or toxic environments

        - 42.1% prefer a structured break every three months to maintain balance
